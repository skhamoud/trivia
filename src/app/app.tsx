    ...
    <main className={styles.main}>
      <header className={styles.header}>
        ...
        <p className={styles.headerDescription}>
          ...
          <code className={styles.headerDescriptionCode}>Atomic organization for components</code>. Configured and ready
          to go.
        </p>
      ...
      <section className={styles.features}>
        {features.map((props, index) => (
          <div key={index} className={styles.cardWrapper} style={{ animationDelay: `${index * 0.1 + 0.1}s` }}>
            <Card
              title={props.name}
